...
%========================================================================== 
% JDQZ 
%   Computes a partial generalized Schur decomposition (or QZ decomposition) 
%   of a pair of square matrices or operators.
%  
%   LAMBDA = JDQZ(A,B) and JDQZ(A,B) return K eigenvalues of the matrix 
%   pair (A,B), where K = min(5,N) and N = size(A,1) if K has not been specified.
%  
...
%   of size (L,1), then the Jth eigenvalue nearest to SIGMA(MIN(J,L)) is 
%   computed for J=1:K. SIGMA is the "target" for the desired eigenvalues.
...
%   'BE'    : Both Ends. Computes K/2 eigenvalues from each end of the 
%             spectrum (one more from the high end if K is odd.)
%  
...
% Created	: 2002
% Last Revised	: Dec 23, 2014 at 10:10 by Karamatou Yacoubou Djima
%==========================================================================

function [mappedX, mapping] = slaplacian_eigen(X, no_dims, k, sigma, xpixs, ypixs, H, G, eig_impl)
...
ypixs=100;
    ...
    save('/Users/math/Desktop/Tim/drtoolbox/techniques/G.mat','G');
    end
...
%     H=squareform(H);
    ...
    H(H~=0);
    sigma_1=1;
    save('/Users/math/Desktop/Tim/drtoolbox/techniques/H.mat','H');
    end
        G=G(conn_comp,conn_comp);
